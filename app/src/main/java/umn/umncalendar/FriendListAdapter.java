    ...
    public void setRemoveFriendListener(View customView, final User friend) {
        ...
        cancelRsvp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Are you sure you remove " + friend.getUser_name() + " from your friend list?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {

                    public void onClick(DialogInterface dialog, int which) {
                        // How to remove the selected item?
                        User.getFriends().remove(friend);
                        Toast.makeText(getContext(), friend.getUser_name()+" removed", Toast.LENGTH_SHORT).show();
