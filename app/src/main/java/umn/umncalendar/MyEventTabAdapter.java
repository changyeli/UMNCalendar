...
public class MyEventTabAdapter extends ArrayAdapter<Event> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        customView = layoutInflater.inflate(R.layout.custom_row_myevent, parent, false);
        ...
        setCancelRsvpListener(customView, singleEvent,parent);
        return  customView;
    }

    public void setCancelRsvpListener(final View customView, final Event event, final ViewGroup parent){
        currEvent=event;
